...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        result = {}
        result = {"class": [{"type_id": "67", "type_name": "尚爱🌠爽剧"},
                            {"type_id": "68", "type_name": "尚爱🌠言情"},
                            {"type_id": "70", "type_name": "尚爱🌠穿越"},
                            {"type_id": "71", "type_name": "尚爱🌠悬疑"},
                            {"type_id": "73", "type_name": "尚爱🌠古装"},
                            {"type_id": "80", "type_name": "尚爱🌠都市"},
                            {"type_id": "84", "type_name": "尚爱🌠甜宠"},
                            {"type_id": "85", "type_name": "尚爱🌠恋爱"},
                            {"type_id": "74", "type_name": "尚爱🌠其他"}],
    ...
    def detailContent(self, ids):
        ...
        content = '白云飘过🎉为您介绍剧情📢👉请不要相信视频中的广告，以免上当受骗！' + self.extract_middle_text(res,'劇情介紹</h3>','</p>', 0)
